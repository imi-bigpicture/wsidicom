...
SLIDES: Dict[str, Dict[str, Any]] = {
    "FULL_WITH_BOT": {
        ...
        "path": "WG26Demo2020_PV/Histech^Samantha [1229631]/20190104 140000 [Case S - Colon polyps]/Series 000 [SM]",
        "files": {
    ...
    "SPARSE_NO_BOT": {
        ...
        "path": "WG26Demo2019_PV/MoticWangjie^Professer [100001]/20190903 102029 [200001]/Series 000 [SM]",
        "files": {
...
def get_or_check_slide(slide_dir: Path, slide: Dict[str, Any], ftp: FTP):
    path = slide_dir.joinpath(slide["path"])
    ftp_path = FILESERVER_SLIDE_PATH.joinpath(slide["path"])
